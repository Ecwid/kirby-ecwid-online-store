...
<div>
    ...
    <?php else: ?>
    <a class="btn btn-rounded" target="_blank" href="https://my.ecwid.com/?partner=kirby#register">Create Free Store</a>  
    <br/>
    <a class="ecwid-connect ecwid-connect-existing ecwid-connect-link" href="javascript:void(0);">Connect Existing Ecwid Store</a>
    <?php endif; ?>
</div>
